...
data:
  custom_docker_entrypoint.sh: |-
      ...
      # Tomcat Mod
      /usr/sbin/groupadd -g 1000 tomcat
      /usr/sbin/useradd -d /usr/local/tomcat -g 1000 -u 1000 -s /bin/bash tomcat
      /bin/chown -R tomcat.tomcat /opt/pega /usr/local/tomcat
